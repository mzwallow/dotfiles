...
Global.tags = require("tags")

-- {{{ Variable definitions
-- Themes define colours, icons, font and wallpapers.
beautiful.init(gears.filesystem.get_themes_dir() .. "default/theme.lua")

modkey = Global.vars.modkey
terminal = Global.vars.terminal
editor = Global.vars.editor
editor_cmd = Global.vars.editor_cmd
...
-- Autorun script
awful.spawn.with_shell("$HOME/Packages/dotfiles/awesome/autorun.sh")
